...
// node_modules/topojson-simplify/node_modules/topojson-client/src/identity.js
function identity_default2(x) {
  return x;
}

// node_modules/topojson-simplify/node_modules/topojson-client/src/transform.js
...
// node_modules/topojson-simplify/node_modules/topojson-client/src/reverse.js
function reverse_default2(array, n) {
  var t, j = array.length, i = j - n;
  while (i < --j) t = array[i], array[i++] = array[j], array[j] = t;
}

// node_modules/topojson-simplify/node_modules/topojson-client/src/feature.js
...
function filterWeight_default(topology, minWeight, weight) {
  ...
  if (weight == null) weight = planarRingArea2;
...
function heap_default() {
  ...
  heap.pop = function() {
    ...
    if (--size > 0) object3 = array[size], down(array[object3._ = 0] = object3, 0);
    return removed;
  };
  heap.remove = function(removed) {
    var i = removed._, object3;
    if (array[i] !== removed) return;
    if (i !== --size) object3 = array[size], (compare(object3, removed) < 0 ? up : down)(array[object3._ = i] = object3, i);
    return i;
  };
  function up(object3, i) {
    while (i > 0) {
      var j = (i + 1 >> 1) - 1, parent = array[j];
      if (compare(object3, parent) >= 0) break;
